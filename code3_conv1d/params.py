...
# tf.flags.DEFINE_integer('hidden_1', 100, 'Size of the third hidden layer. Should be positive. default: -1.')
...
tf.flags.DEFINE_integer('max_q_len', 21, 'Maximum query length. default: 10.')
tf.flags.DEFINE_integer('max_doc_len', 250, 'Maximum document length. default: 1000.')
